...
echo ""
echo "2. Starting to terminate ego related nodes..."
...
rostopic pub -1 /ego_planner_node/optimal_list visualization_msgs/Marker "
header:
  seq: 0
...
rostopic pub -1 /ego_planner_node/goal_point visualization_msgs/Marker "
header:
  frame_id: 'world'
ns: 'goal_point'
action: 3
