...
(cl:defmethod cl:initialize-instance :after ((m <ObjectCount>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectCount)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_detection_msgs-msg:<ObjectCount> is deprecated: use object_detection_msgs-msg:ObjectCount instead.")))
...
(cl:defmethod count-val ((m <ObjectCount>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection_msgs-msg:count-val is deprecated.  Use object_detection_msgs-msg:count instead.")
  (count m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ObjectCount>)))
  ...
  "object_detection_msgs/ObjectCount")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ObjectCount)))
  "Returns string type for a message object of type 'ObjectCount"
  "object_detection_msgs/ObjectCount")
