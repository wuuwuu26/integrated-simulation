...
struct MD5Sum< ::quadrotor_msgs::Px4ctrlDebug_<ContainerAllocator> >
{
  ...
  {
    return "ef7c0d05ca5e817178ee4d4782a75f53";
  }

  static const char* value(const ::quadrotor_msgs::Px4ctrlDebug_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xef7c0d05ca5e8171ULL;
  static const uint64_t static_value2 = 0x78ee4d4782a75f53ULL;
};
