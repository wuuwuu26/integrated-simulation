...
class PolyTraj(genpy.Message):
  _md5sum = "2b8c6612e46f1cb8e6f8c27cf3dfae49"
...
float32[] duration
"""
  __slots__ = ['drone_id','traj_id','start_time','hover','yaw','hover_p','order','coef_x','coef_y','coef_z','duration']
  _slot_types = ['int16','int32','time','bool','float32','float32[]','uint8','float32[]','float32[]','float32[]','float32[]']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_hi2IBf().pack(_x.drone_id, _x.traj_id, _x.start_time.secs, _x.start_time.nsecs, _x.hover, _x.yaw))
      length = len(self.hover_p)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.hover_p))
      _x = self.order
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.drone_id, _x.traj_id, _x.start_time.secs, _x.start_time.nsecs, _x.hover, _x.yaw,) = _get_struct_hi2IBf().unpack(str[start:end])
      self.hover = bool(self.hover)
      start = end
      end += 4
      ...
      self.hover_p = s.unpack(str[start:end])
      start = end
      end += 1
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.hover_p.tostring())
      _x = self.order
      buff.write(_get_struct_B().pack(_x))
      length = len(self.coef_x)
      buff.write(_struct_I.pack(length))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.hover_p = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 1
      (self.order,) = _get_struct_B().unpack(str[start:end])
      start = end
...
def _get_struct_B():
    ...
    return _struct_B
_struct_hi2IBf = None
def _get_struct_hi2IBf():
    global _struct_hi2IBf
    if _struct_hi2IBf is None:
        _struct_hi2IBf = struct.Struct("<hi2IBf")
    return _struct_hi2IBf
